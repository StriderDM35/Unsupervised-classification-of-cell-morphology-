...
#Load images and resize them if they are not 512 by 512
...
cell_9_read = load_image("full_data/MEF_FN_new/")
...
def img_aug(img_stack):
  ...
  cell_stack = np.vstack((cell_lr, cell_ud, cell_ss, cell_sl, cell_45, cell_135, cell_225, cell_315, cell_noise, cell_multiply,
   cell_dropout, cell_saltpepper)) #To reduce memory usage
...
img_stack_resize = img_stack.reshape(-1, 256, 256, 3)
...
print(model.summary())
print("\nChecking the number of classes/images used = ", no_of_class)
